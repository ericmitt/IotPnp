...
namespace Thermostat
{
    public class Program
    {
        ...
        private static readonly string s_moduleId = "EM_Module02";
        ...
        private static async Task InvokeCommandAsync()
        {
            ...
            CloudToDeviceMethodResult result = await s_serviceClient.InvokeDeviceMethodAsync(s_deviceId, s_moduleId, commandInvocation);
